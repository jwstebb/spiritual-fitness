 ...
 */
public class CourseActivityListActivity extends FragmentActivity
        implements CourseActivityListFragment.Callbacks {
    ...
    /**
     * Callback method from {@link CourseActivityListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(CourseActivityDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(CourseActivityDetailFragment.ARG_ITEM_ID, id);
